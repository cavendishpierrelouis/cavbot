// CavBot · Control Stack (Gen X6+)
// Unified core: game logic + analytics + head/body/badge eye tracking
...
(function () {
  ...
  // Public brain API for other pages / future backend
  try {
  ...
  (function initGameArena() {
    ...
    const FIRST_VISIT_LINES = [
      'CAVBOT · ONLINE · CONTROL STACK · GEN X6',
    ...
    typewriterLines([
      'CONTROL ROOM · ONLINE',
      'STACK · CONTROL STACK (GEN X6) · RELIABILITY COPILOT MODE',
  ...
  // ===== CavBot Badge Eye Tracking (DM avatar) =====
  // Direct lift from your original badge.js
